...
| Scenario | ~$ |
|----------|----|
| **Everything above (primary picks, single-servo, incl. structural PLA)** | **~$215** |
| If you already own PLA/PETG filament | **~$195** |
| Trimmed (skip the now-redundant barrel adapter, reuse some wire) | **~$175** |
