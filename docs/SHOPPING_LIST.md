...
| ☐ | Line stopper beads | small plastic beads (or fishing crimp sleeves) — one per cable, locked with figure-8 knots, trips the homing switch ~4 mm before zero | https://www.amazon.com/s?k=fishing+line+stopper+beads | 5 |
